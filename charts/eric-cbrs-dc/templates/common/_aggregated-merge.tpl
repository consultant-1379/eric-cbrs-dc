...
{{- define "eric-cbrs-dc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-cbrs-dc.mergeAnnotations" -}}
  {{- include "eric-cbrs-dc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-cbrs-dc.mergeLabels" -}}
  {{- include "eric-cbrs-dc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
